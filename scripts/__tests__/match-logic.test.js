...
const cases = [
  ...
  [4,  "Lavazza Kaffee",       "Lavazza Crema e Aroma",               true,    "erstes Token (Marke, >=7)"],
  ...
  [11, "Wiener knusperbraten", "Wiener Schnitzel",                    false,   "erstes Token <7 Zeichen; knusperbraten fehlt"],
